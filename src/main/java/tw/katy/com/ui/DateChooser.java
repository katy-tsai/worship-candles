...
public class DateChooser extends JPanel {
	...
	@SuppressWarnings("unused")
	private JP4 jp4;
	private Font font = new Font(Font.SERIF, Font.PLAIN, 15);
	...
	private Dimension textDimension= new Dimension(500, 30);
	...
	private void initLabel() {
		...
		showDate = new JLabel();
		showDate.setSize(textDimension);
		showDate.setFont( new Font(Font.SERIF, Font.PLAIN, 20));
		dateBtn = new JButton();
		dateBtn.setMargin(new Insets(0,0,0,0)); 
		dateBtn.setIconTextGap(0);
		dateBtn.setBorderPainted(false);
		dateBtn.setBorder(null);
		dateBtn.setText(null);
		dateBtn.setFocusPainted(false);
		dateBtn.setContentAreaFilled(false);
		dateBtn.setIcon(new ImageIcon(getClass().getClassLoader().getResource("calendar.png"))); 
		
		showDate.setRequestFocusEnabled(true);
		dateBtn.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent me) {
				dateBtn.requestFocusInWindow();
			}
		});
		dateBox.add(showDate);
		dateBox.add(Box.createHorizontalStrut(60));
		dateBox.add(dateBtn);
		...
		dateBtn.addFocusListener(new FocusListener() {
			public void focusLost(FocusEvent e) {
				hidePanel();
			}
